            ...
            <div class="fr w320">
                ...
                <div class="plr20-tb15 bg-ff box-shadow mt20" >
                    ...
                    @foreach($latestnews as $latestnew)
                        @if($loop->first)
                        <a target="_blank" href="/news/{{$latestnew->id}}.shtml" class="img-block magnify magnify-txt h213 mt15"><img src="{{$latestnew->litpic}}" alt="{{$latestnew->title}}">
                            <div class="img-bg"></div>
                            <p>{{$latestnew->title}}</p>
                        </a>
                        @endif
                    ...
                    <ul class="tw-list tw-list-h80 mt5">
                        @foreach($latestnews as $latestnew)
                            @if(!$loop->first)
                                <li><a target="_blank" href="/news/{{$latestnew->id}}.shtml" class="img-block magnify"><img  @if($latestnew->litpic) src="{{$latestnew->litpic}}" alt="{{$latestnew->tite}}" @else src="/public/images/noimg.jpg" @endif /></a>
                                    <p class="f16">
                                        <a target="_blank" href="/news/{{$latestnew->id}}.shtml">{{$latestnew->title}}</a>
                                    </p>
                                    <p class="f14 s-8c">{{$latestnew->created_at}}
                                    </p>
                                </li>
                            @endif
                        @endforeach
