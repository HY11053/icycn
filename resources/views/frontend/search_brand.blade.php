...
@section('headlibs')
    <meta name="Copyright" content="世纪母婴网-{{env('APP_URL')}}"/>
    <meta name="author" content="世纪母婴网" />
...
@section('main_content')
    <div class="main">
        ...
        <div class="path">当前位置：<a href="/">首页</a> &gt; 项目搜索页</div>
        <div class="main clearfix">
            <div class="cate_sort">
                ...
                <dl>
                    ...
                    @foreach($touziids as $touziid)
                        <dd><a target="_self" href="/muying/filter/p{{$touziid}}/">{{$investments[$touziid]}}</a></dd>
                    @endforeach
                ...
                <dl>
                    ...
                    @foreach($acreagements as $index=>$acreagement)
                        <dd><a target="_self" href="/muying/filter/m{{$index}}/">{{$acreagement}}平米</a></dd>
                    @endforeach
                ...
                <dl>
                    ...
                    @foreach($arealists as $arealist)
                        <dd><a target="_self" href="/muying/filter/a{{$arealist->id}}/">{{$arealist->regionname}}</a></dd>
                    @endforeach
                </dl>
            </div>
            ...
            <div class="w910">
                <div class="order_item">
                    ...
                    <div class="order_item_r">共找到<span>{{$pagelists->total()}}</span>个加盟项目</div>
                </div>
