...
<header>
    <div class="header">
        <div class="top">
            <div class="inner">
                <div class="top_l">您好，欢迎访问世纪母婴网！</div>
                <div class="top_r">
                    <div class="tel">7*24小时免费直拨 400-885-8878</div>
            ...
            <div class="header_box">
                ...
                <div class="search">
                    <div class="search_tab">
                        <ul>
                            <li class="cur">找商机</li>
                            <li><a target="_self" href="/muying/filter/p4/">10~20万</a></li>
                            <li><a target="_self" href="/muying/filter/p2/">5万~10万</a></li>
                            <li><a target="_self" href="/muying/filter/p6/">20万~50万</a></li>
                            <li><a target="_self" href="/muying/filter/p3/">10~15万</a></li>
                        </ul>
                    </div>
                    <div class="search_box">
                        <form action="/search/" method="post">
                            {{csrf_field()}}
                            <input type="text" onblur="if (this.value == '') {this.value = this.attributes['def'].value;this.className='search_input';}" onfocus="if (this.value == this.attributes['def'].value) {this.value='';this.className='search_input1';}" def="想找什么项目？" class="search_input" value="想找什么项目？" name="title">
                ...
                <div class="quick_btn">
                    <ul>
                        ...
                        <li>
                            <a href="/touzi/"><i class="icon3"></i><span class="tit">投资开店</span></a>
                        </li>
                        <li>
...
<footer>
    <div class="footer">
		...
		报警平台</a></span>
                ...
                <p>
                    <span class="fl"><a href="http://www.cyberpolice.cn/wfjb/" target="_blank" rel="nofollow"><img width="36" height="42" border="0" alt="公共信息安全网络监察" src="/receptions/images/temp/6743671.jpg"></a></span>
                    <span class="fr"><a href="http://www.cyberpolice.cn/wfjb/" target="_blank" rel="nofollow">公共信息安<br>
		全网络监察</a></span>
                </p>
                ...
                <p>
                    ...
                    <span class="fr"><a target="_blank" class="lcblack" href="http://beian.miit.gov.cn/" rel="nofollow">经营性网站<br>
		备案信息</a></span>
                </p>
                <p>
                    ...
                    <span style="width:64px;" class="fr"><a class="lcblack" href="http://www.12377.cn/" target="_blank" rel="nofollow">中国互联网举报中心<br>
		举报中心</a></span>
                </p>
                <p>
                ...
                <p>
                    <span style="width:44px;" class="fl"><a href="http://samr.saic.gov.cn/" target="_blank" rel="nofollow"><img src="http://mat1.gtimg.com/www/images/qq2012/gswj2015.jpg"></a></span>
                    <span style="width:64px;" class="fr"><a class="lcblack" href="http://samr.saic.gov.cn/" target="_blank" rel="nofollow">工商网监<br>电子标识</a></span>
                </p>
            </div>
        </div>
    ...
    <script type="text/javascript" src="/receptions/js/jquery.SuperSlide.2.1.1.js"></script>
