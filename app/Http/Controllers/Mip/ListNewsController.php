...
class ListNewsController extends Controller
{
    ...
    public function listNews(Request $request,$path,$page=0)
    {
        ...
        if($thistypeinfo->mid==0)
        {
            ...
            return view('mip.index_lists',compact('thistypeinfo','pagelists','hotnew','cnewtop','cnew','cnewtops','paihangbangs','latestbrands','latestnews','abrandlists'));
        }elseif ($thistypeinfo->mid==1)
        {
            ...
            return view('mip.brands',compact('thistypeinfo','topbrandnavs','pagelists','paihangbangs','flashlingshibrands','cnewslists','hotbrandsearch','acreagements'));
        }
    ...
    public function projectBrandLists($path,$tid=0,$cid=0,$zid=0,$page=0)
    {
        ...
        return view('mip.project_brands',compact('thistypeinfo','flashlingshibrands','topbrandnavs','pagelists','paihangbangs','tid','cid','cnewslists','zid','acreagements'));
    }
